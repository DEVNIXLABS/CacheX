 ...
 * 
 * Main CacheX class that orchestrates the hybrid caching system
 */
var CacheX = /*#__PURE__*/function () {
  /**
   * Creates a new CacheX instance
  ...
  return _createClass(CacheX, [{
    ...
    value: function get(key) {
      ...
      if (value !== undefined) {
        ...
        // Sync to memory cache for future fast access
     ...
     * @param {Object} options - Cache options (ttl, persistence, etc.)
     */
  }, {
    key: "set",
     ...
     * @returns {CacheX} New CacheX instance for namespace
     */
  }, {
    key: "createNamespace",
     ...
     * @param {string} name - Namespace name
     * @returns {CacheX} CacheX instance for namespace
     */
  }, {
    key: "useNamespace",
