...
var AnalyticsEngine = /*#__PURE__*/function () {
  /**
   * Creates a new AnalyticsEngine instance
   */
  function AnalyticsEngine() {
    ...
    this.entryStats = new Map(); // Per-key statistics
  }
  ...
  return _createClass(AnalyticsEngine, [{
     ...
     * @param {number} usage - Memory usage in bytes
     */
  }, {
     ...
     * @param {number} usage - Storage usage in bytes
     */
  }, {
     ...
     * @returns {Map} All entry statistics
     */
  }, {
     ...
     * @returns {string} Formatted analytics report
     */
  }, {
    key: "getReport",
